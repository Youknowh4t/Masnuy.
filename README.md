...
<body>
  ...
  <form action="" method="get">
    <input type="hidden" name="by masnuy.png">
  </form>
  ...
  <footer class="page-footer font-small blue fixed-bottom">
    ...
    <!-- Copyright -->
    <div class="footer-copyright text-center py-3 text-secondary"><small> From Masnuy.png
        <i class="fas fa-heart text-danger animate__animated animate__bounce animate__repeat-3 hati"></i> To Someone
